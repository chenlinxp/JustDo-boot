...
public class ResourceDO extends BaseBean {
    ...
    */
    public ResourceDO(){ }
    public ResourceDO(String ResourceId,String ParentId,String ResourceName,String ResourceUrl,String ResourcePermission,Integer ResourceType,String ResourceIcon,Integer OrderNum,Date CreateTime,Date ModifyTime){
		super();
