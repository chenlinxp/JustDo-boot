...
public class ErrorLogDO extends BaseBean {
    ...
    * 构造方法
    */
    public ErrorLogDO(String ErrorlogId,String UserId,String UserName,String ExceptionContent,Integer ExceptionState,String Remark,String Ip,String CreateTime) {
	    super();
	    this.userId = userId;
