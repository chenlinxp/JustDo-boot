...
param = sys.argv[1]
pngs = getFiles(param+"tmp/")
# dirs, pngs = getFiles(param)
print "ok"
...
if os.path.exists(param+'icon.png'):
    os.remove(param+'icon.png')
shutil.move(param+'tmp/icon.png',param)
# print "[+] %d PNG filename were :" % filename
# for filename in glob.glob(r''+param+'tmp/*.png'):
#     print "[+] %d PNG filename were :" % filename
# 	shutil.move(filename,param)
# 	print filename
